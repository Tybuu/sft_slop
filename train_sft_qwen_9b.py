...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./qwen-9b-expert")
    ...
    print(f"Loading model (4-bit QLoRA): {args.model_path}")
    ...
    print("Starting 9B Expert Teacher Fine-Tuning...")
