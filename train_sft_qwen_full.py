...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./qwen-2b-full")
    ...
    print(f"Loading model (BF16 full fine-tune): {args.model_path}")
    ...
    print("Starting Full Parameter Fine-Tuning (no LoRA)...")
